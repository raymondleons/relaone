...
export const getArticle = () => {
    return dispatch => {
        ...
        {
            headers: { "x-access-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..51UDxGnzD6fR6zESu9B8MRGCyKV1oGWDIK3FtOkYmps"}
        })
        .then(res => {
              dispatch ({
                  type: GET_ARTICLE,
  ...
  return dispatch => {
    console.log(fullname, username, email, idCard, birthDate, address, phoneNumber, bio)
      axios ({
          ...
          method: 'put',
          headers: { 
              'x-access-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..51UDxGnzD6fR6zESu9B8MRGCyKV1oGWDIK3FtOkYmps'
          },
          data: {
            fullname, 
            username, 
