            ...
            <div id="sidebar-menu">
                <ul>
                    <li className="submenu">
                        <a href="/admin/dashboard" className="active"><i className="fa fa-fw fa-bars"></i><span> Dashboard </span></a>
                    </li>
                    <li className="submenu">
                    ...
                    <li className="submenu">
                        <a href="/admin/organization" className="active"><i className="fa fa-users"></i> <span> Organization </span> <span class="menu-arrow"></span></a>
                          <ul className="list-unstyled">
